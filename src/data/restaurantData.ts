...
export const GALLERY_ITEMS: GalleryItem[] = [
  {
    id: 'g-1',
    title: "1974 Signature Dal Makhani Simmering in Brass Handi",
    category: 'food',
    image: DISH_IMAGES.dalMakhaniSignature,
    caption: '18 hours of slow clay tandoor simmering with pure farm white butter.',
    location: 'Flagship Kitchen',
  },
  {
    id: 'g-2',
  ...
  {
    id: 'g-3',
    title: 'Charcoal Bhatti Da Murgh Hot off Skewers',
    category: 'food',
    image: DISH_IMAGES.bhattiDaMurgh,
    caption: 'Roasted whole spices, deghi mirch, and natural wood smoke.',
  ...
  },
  {
    ...
    category: 'events',
    image: VENUE_IMAGES.newBelRoadBanquet,
    caption: 'Spacious seating for family milestones, anniversaries, and corporate banquets.',
    location: 'New BEL Road',
  },
  {
    id: 'g-5',
    title: 'Paneer Tikka Lazeez with Roasted Peppers',
    category: 'food',
    image: DISH_IMAGES.paneerTikkaLazeez,
    caption: 'Handcrafted fresh malai paneer with hung curd and mustard oil marinade.',
    location: 'Both Locations',
  },
  {
    id: 'g-6',
    title: '50-Year Anniversary Patron Reunion',
    category: 'celebrations',
    image: VENUE_IMAGES.royalFeastTable,
    caption: 'Celebrating five decades of heartfelt memories with our earliest patrons.',
    location: 'Church Street',
  },
  {
    id: 'g-7',
    title: 'Live Charcoal Tandoor Embers & Skewers',
    category: 'heritage',
    image: VENUE_IMAGES.tandoorLiveHearth,
    caption: 'The authentic tandoor clay hearth stoked with natural wood lump charcoal.',
    location: 'Historical Hearth',
  },
  {
    id: 'g-8',
    title: 'Shahi Gosht Dum Biryani Handi Sealed with Dough',
    category: 'food',
    image: DISH_IMAGES.goshtDumBiryani,
    caption: 'Aged basmati rice, tender lamb, saffron, and caramelised onions in dum.',
    location: 'Kitchen Showcase',
  },
  {
    id: 'g-9',
    title: 'Kesari Phirni Chilled in Unglazed Clay Pots',
    category: 'food',
    image: DISH_IMAGES.kesariPhirniClayPot,
    caption: 'Sweetened milk, ground rice, and Kashmiri saffron with silver vark.',
