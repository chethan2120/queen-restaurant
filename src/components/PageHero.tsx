...
export const PageHero: React.FC<PageHeroProps> = ({
  ...
  return (
    <section className="bg-[#1E1714] text-[#FCFAF5] py-16 sm:py-20 lg:py-24 relative overflow-hidden text-center border-b border-[#B58A4A]/30 min-h-[360px] sm:min-h-[400px] flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(181,138,74,0.12),transparent_70%)] z-0" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 my-auto">
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-serif font-bold text-[#FCFAF5] tracking-tight leading-tight">
          {title}
        </h1>

        <p className="text-xs sm:text-sm lg:text-base text-[#D8CEBE] max-w-2xl mx-auto font-light leading-relaxed">
          {description}
        </p>
